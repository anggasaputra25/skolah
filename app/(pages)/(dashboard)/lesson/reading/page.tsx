...
import { faBookOpen, faCheck, faHeart, faVolumeHigh, faXmark } from "@fortawesome/free-solid-svg-icons";
    ...
    return (
        <div className="min-h-screen flex flex-col justify-between bg-slate-50">
            ...
            <div className="max-w-4xl w-full mx-auto p-5 flex items-center gap-6">
                ...
                {/* Hearts / Health */}
                <div className="flex items-center gap-2 font-black text-red-500 text-lg">
