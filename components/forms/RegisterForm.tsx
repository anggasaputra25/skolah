...
const RegisterForm = () => {
    ...
    return (
        <>
            ...
            {/* Register Form */}
            {!showFlags && 
                <BorderCard className="w-full max-w-md lg:max-w-5xl bg-white my-20 md:my-10 overflow-hidden flex p-0!">
                    <Image
                        src="/assets/register.jpg" 
                        alt="Register" 
                        width={500} 
                        height={600} 
                        className="object-cover w-full spect-auto hidden lg:inline-block" 
                    />
