        ...
        <div className="min-h-dvh border-r-2 border-slate-300 w-fit min-w-72">
            <div className="p-8 sticky top-0">
                ...
                <div className="space-y-2 mt-5 text-slate-500">
                    <Link href={'/Learn'} className="w-full rounded-2xl px-4 py-2 border-2 border-blue-300 bg-blue-100 text-blue-600 flex items-center gap-2">
                        <FontAwesomeIcon icon={faBrain} className="w-4 h-4" />
                        <span>Learn</span>
                    </Link>
                    <Link href={'/Learn'} className="w-full rounded-2xl px-4 py-2 hover:bg-slate-100 flex items-center gap-2">
